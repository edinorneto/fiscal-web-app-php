...
![Menu principal](screenshots/index.png)
![Resultado da consulta](screenshots/consulta_resultado.png)
...
```bash
git clone https://github.com/edinorneto/fiscal-web-app-php.git
cd fiscal-web-app-php
